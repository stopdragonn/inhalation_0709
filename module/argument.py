...
def get_parser():
    ...
    parser.add_argument('--ad_k', type=int, default=3, help='the number of neighbors for AD calculation')
    parser.add_argument('--ad_z', type=float, default=0.5, help='Z value for AD threshold calculation')
